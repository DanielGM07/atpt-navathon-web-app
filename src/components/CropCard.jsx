...
import { Card, CardActionArea, Collapse, Box, Typography, Divider, IconButton } from '@mui/material'
...
const difficultyStyles = {
  ...
  advanced: theme => ({
    bg: theme.palette.orange?.light ? theme.palette.orange.light + '22' : theme.palette.warning.dark + '22',
...
export default function CropCard({ name, emoji, difficulty, phRange, growthCycle, description, temperature, light }) {
  ...
  return (
    <Card
      ...
      <CardActionArea onClick={() => setOpen(v => !v)} sx={{ p: 2, alignItems: 'stretch', display: 'block' }}>
